...
var storeAnswer = function (question, answer) {
  assert((question.required || !question.optional) &&
         (answer === undefined && question.default !== undefined,
           && question.length !== undefined? question.length !== 0:true ||
          answer.length !== undefined? answer.length !== 0:true),
         'Answer must be filled');
  // Check if answer is not equal to default value or is undefined
  return (answer !== undefined && question.default !== answer &&
          answer.length !== undefined? answer.length !== 0:true);
};
